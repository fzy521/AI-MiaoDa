        ...
        <header className="sticky top-0 z-30 h-16 bg-background flex items-center justify-between px-4 md:px-8">
          <div className="flex items-center gap-4 flex-1">
            <div className="relative hidden md:block w-full max-w-2xl">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-3 bg-white border border-transparent rounded-full text-sm focus:bg-white focus:border-transparent focus:shadow-google transition-all outline-none"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-4 ml-4">
            <button className="relative p-2 text-muted-foreground hover:bg-black/5 rounded-full transition-colors">
              <Bell size={24} />
              <span className="absolute top-2 right-2 w-2 h-2 bg-risk-red-text rounded-full border-2 border-background" />
            </button>
