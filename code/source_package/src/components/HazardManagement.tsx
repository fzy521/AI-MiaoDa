  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button className="bg-primary text-primary-foreground px-6 py-2.5 rounded-full font-medium flex items-center gap-2 shadow-google hover:shadow-google-hover transition-all">
          <Plus size={20} />
          上报新隐患
        </button>
      </div>
      ...
      <div className="bg-white rounded-full p-2 flex flex-col md:flex-row gap-4 items-center justify-between shadow-sm border border-border">
        ...
        <div className="relative w-full md:w-72 pr-2">
          ...
          <input 
            ...
            className="w-full pl-11 pr-4 py-2 bg-muted/50 border border-transparent rounded-full text-sm focus:outline-none focus:bg-white focus:border-transparent focus:shadow-google transition-all"
          />
        </div>
      </div>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className={cn("text-xs font-medium px-2 py-0.5 rounded-md", 
                        hazard.level === 'RED' ? 'bg-risk-red-bg text-risk-red-text' :
                        hazard.level === 'ORANGE' ? 'bg-risk-orange-bg text-risk-orange-text' :
                        hazard.level === 'YELLOW' ? 'bg-risk-yellow-bg text-risk-yellow-text' :
                        'bg-risk-blue-bg text-risk-blue-text'
                      )}>
