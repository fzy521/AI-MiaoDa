            ...
            <tr key={w.id} className="hover:bg-accent/50 transition-colors">
              ...
              <td className="px-6 py-4">
                <span className={cn(
                  ...
                  w.status === 'ACTIVE' ? "bg-success-bg text-success-text border-success-text/20" : "bg-muted text-muted-foreground border-border"
                )}>
              ...
              <td className="px-6 py-4 text-right">
                <div className="flex justify-end gap-2">
                  ...
                  <button className="p-1.5 text-muted-foreground hover:text-risk-red-text hover:bg-risk-red-bg rounded-md transition-colors">
                    <Trash2 size={16} />
                  </button>
                </div>
              </td>
            ...
            <tr key={s.id} className="hover:bg-accent/50 transition-colors">
              ...
              <td className="px-6 py-4">
                <span className={cn(
                  ...
                  s.type === 'DESTINATION' ? "bg-green-50 text-success-text border-success-text/20" :
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button className="flex items-center gap-2 px-6 py-2.5 bg-primary text-white rounded-full text-sm font-bold shadow-google hover:shadow-google-hover transition-all">
          <Plus size={18} />
          新增记录
        </button>
      </div>
