      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {kpiData.map((kpi, i) => (
          <div key={i} className={cn(
            ...
            kpi.level === 'RED' && "bg-risk-red-bg/50 border-risk-red-text/20",
            kpi.level === 'ORANGE' && "bg-risk-orange-bg/50 border-risk-orange-text/20",
            kpi.level === 'YELLOW' && "bg-risk-yellow-bg/50 border-risk-yellow-text/20",
            kpi.level === 'SUCCESS' && "bg-success-bg/50 border-success-text/20"
          )}>
            <div className="flex justify-between items-start mb-4">
              <span className="text-sm font-medium text-muted-foreground">{kpi.label}</span>
              <div className={cn(
                "flex items-center text-xs font-medium px-2 py-1 rounded-full",
                kpi.trend > 0 ? "bg-risk-red-bg text-risk-red-text" : "bg-success-bg text-success-text"
              )}>
